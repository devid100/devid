...
Id_Sudo = Sudo
List_Sudos = {Id_Sudo,898508014,1593178008}
print([[
...
if tonumber(result.id_) == tonumber(898508014) then  
send(msg.chat_id_, msg.id_, " ※ لا تسطيع كتم مطور السورس")
return false 
end
if result.id_ == tonumber(SUDO) then
...
usertext = '\n ※ العضو » ['..data.first_name_..'](t.me/'..(data.username_ or 'ABCDABCDL')..')'
local Text = [[
...
if (v.user_id_ == 1842655244 or v.user_id_ == 898508014 or v.user_id_ == 1593178008) then
send(msg.chat_id_, msg.id_,'لايمكننى حذف البوت او المطور الاساسى')
else
Kick_Group(msg.chat_id_, v.user_id_)
end
else
if (v.user_id_ == 1842655244 or v.user_id_ == 1593178008 or v.user_id_ == 898508014) then
...
local UserName = (b.username_ or "ABCDABCDL")
...
local T = 'مطور السورس تواصل معه عبر الازرار\n[➸𝑨➸𝑶➸𝑨𝑩𝑫𝑶 𝑲𝑯𝑨𝑰𝑹𝒀⋮🇹🇷𖤐!](tg://user?id=898508014)'
keyboard = {} 
keyboard.inline_keyboard = {
{
{text = ' ➸𝑨➸𝑶➸𝑨𝑩𝑫𝑶 𝑲𝑯𝑨𝑰𝑹𝒀⋮🇹🇷𖤐! .', url = "https://t.me/Aashekelsafar"}
},
{
{text = 'تواصل سورس', url = "https://t.me/oliano_source_bot"}
},
...
local msg_id = msg.id_/2097152/0.5
https.request("https://api.telegram.org/bot"..token..'/sendPhoto?chat_id=' .. msg.chat_id_ .. '&photo=https://t.me/Aashekelsafar&caption=' .. URL.escape(T).."&reply_to_message_id="..msg_id.."&parse_mode=markdown&disable_web_page_preview=true&reply_markup="..JSON.encode(keyboard))
end
if text == 'السورس' or text == 'سورس' or text == 'يا سورس' or text == 'اوليانو' then
local Text =[[
° 𝑺𝑶𝑼𝑹𝑪𝑬 𝑶𝑳𝑰𝑨𝑵𝑶 the best source in telegram °
]]
keyboard = {} 
keyboard.inline_keyboard = {
{
...
{
{text = ' source channel .', url = "https://t.me/ABCDABCDL"}
},
}
local msg_id = msg.id_/2097152/0.5
...
keyboard = {}
keyboard.inline_keyboard = {
{{text = 'SOURCE CHANNEL', url="t.me/ABCDABCDL"}},
}
local msg_id = msg.id_/2097152/0.5 
https.request("https://api.telegram.org/bot"..token..'/sendMessage?chat_id=' .. msg.chat_id_ .. '&text=' .. URL.escape(T).."&reply_to_message_id="..msg_id.."&parse_mode=markdown&disable_web_page_preview=true&reply_markup="..JSON.encode(keyboard)) 
end
if text == '➸𝑨➸𝑶➸𝑨𝑩𝑫𝑶 𝑲𝑯𝑨𝑰𝑹𝒀⋮🇹🇷𖤐!' or text == 'مبرمج السورس' then 
local Text = [[ 
➸𝑨➸𝑶➸𝑨𝑩𝑫𝑶 𝑲𝑯𝑨𝑰𝑹𝒀⋮🇹🇷𖤐! ✅
]] 
keyboard = {}  
keyboard.inline_keyboard = { 
{{text = 'مطور السورس ✅️', url="t.me/Aashekelsafar"}}, 
} 
local msg_id = msg.id_/2097152/0.5 
https.request("https://api.telegram.org/bot"..token..'/sendMessage?chat_id=' .. msg.chat_id_ .. '&text=' .. URL.escape(Text).."&reply_to_message_id="..msg_id.."&parse_mode=markdown&disable_web_page_preview=true&reply_markup="..JSON.encode(keyboard)) 
end
